    ...
    <!-- Navbar -->
        <nav class="navbar navbar-expand-md navbar-dark bg-danger">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo base_url()."index.php/admin/donasi" ?>">Donasi</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="#">List Donasi</a>
                </li>
                <li class="nav-item">
        ...
        <table class="table table-hover">
            ...
            <tr>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-primary" href="<?php echo base_url()."index.php/admin/verif_donasi/".$r['id_donasi']; ?>">Verif</a>
                        <a class="btn btn-danger" href="<?php echo base_url()."index.php/admin/hapus/".$r['id_donasi']; ?>">Hapus</a>
                    </td>
                </tr>
                <?php
                    $no++;
